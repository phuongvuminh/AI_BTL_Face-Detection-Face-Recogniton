...
class FaceDetector:
    ...
    def prepare(self, ctx_id, nms=0.4, fix_image_size=None):
        ...
        model = mx.mod.Module(symbol=sym, context=ctx_id, label_names=None)
...
def get_retinaface(name, rac='net3', root='models_detection/retinaface_r50_v1/R50-0000.params', **kwargs):
    return FaceDetector(root, rac)
